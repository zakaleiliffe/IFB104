...
# turtle graphics demonstration from the Week 4 lecture notes.  The
...
# Turtle's "xcor" and "ycor" functions.
#
...
step_numbers = range(3000)  # how many steps to take in the simulation
