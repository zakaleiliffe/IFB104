...
# prompts the user to enter a non-negative number.  For each
# number entered, the function prints the sum of all
# the numbers entered so far.  It stops when any negative
# number is entered.
#
...
#
# Note that we have used the "input" function below which
...
##    ** Enter a negative number to stop the program
...
# sum of all the numbers entered so far, until a negative
# number is entered
def totaliser():
    ...
    # As long as the user's response is not negative display the
    # running total
    while response >= 0:
