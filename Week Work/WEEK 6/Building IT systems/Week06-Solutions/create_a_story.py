...
# Create a list of numbers, one for each name
name_numbers = range(len(old_names))

# Process each line in the file
for line in story:
    # Replace each old name with the corresponding new one
    for name_no in name_numbers:
        line = line.replace(old_names[name_no], new_names[name_no])
    # Print the modified line (without adding another newline)
    print line,
