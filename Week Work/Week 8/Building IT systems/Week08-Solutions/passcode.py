...
zero_button =  Button(passcode_window, text = '0', command = process_zero)
zero_button.grid(column = 2, row = 4)
one_button =   Button(passcode_window, text = '1', command = process_one)
one_button.grid(column = 1, row = 1)
two_button =   Button(passcode_window, text = '2', command = process_two)
two_button.grid(column = 2, row = 1)
three_button = Button(passcode_window, text = '3', command = process_three)
three_button.grid(column = 3, row = 1)
four_button =  Button(passcode_window, text = '4', command = process_four)
four_button.grid(column = 1, row = 2)
five_button =  Button(passcode_window, text = '5', command = process_five)
five_button.grid(column = 2, row = 2)
six_button =   Button(passcode_window, text = '6', command = process_six)
six_button.grid(column = 3, row = 2)
seven_button = Button(passcode_window, text = '7', command = process_seven)
seven_button.grid(column = 1, row = 3)
eight_button = Button(passcode_window, text = '8', command = process_eight)
eight_button.grid(column = 2, row = 3)
nine_button =  Button(passcode_window, text = '9', command = process_nine)
