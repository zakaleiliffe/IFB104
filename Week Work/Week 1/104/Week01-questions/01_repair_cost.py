...
repairs = panel_beating + mechanics + spray_painting + tyres

print 'Cost before taking out deposit', repairs

amount_once_removed_deposit = repairs - deposit

print 'Amount owing:', amount_once_removed_deposit
