...
print 'number of pages with 1 digit', num_one_digit_pages
num_two_digit_pages = 99 - num_one_digit_pages
print 'number of pages with 2 digit', num_two_digit_pages
num_three_digit_pages = 732 - (num_two_digit_pages + num_one_digit_pages)
print 'number of pages with 3 digit', num_three_digit_pages

# Now work out how many individual digits there are

total_digits = total_number_of_pages * 2


# Finally print the result       

print 'You will have to write', 732, 'digits'
