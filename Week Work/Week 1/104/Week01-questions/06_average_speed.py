...
distance_from_home_to_uni = 6.0 # km
...
time_to_get_to_uni = 0 # hours

time_to_get_home = 0 # hours

total_travelling_time = 0 # hours

total_distance_travelled = 0 # km

speed_for_round_trip = 0 # km/hr

print 'The average speed for the round trip was', 0, 'km/hr'
