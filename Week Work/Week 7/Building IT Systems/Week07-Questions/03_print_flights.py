...
# Your tasks:
#
# 1) Browse the database's contents in the phpMyAdmin
# interface to ensure that you're familiar with its tables and
# their columns.
#
# 2) In the phpMyAdmin interface, develop a SELECT query which prints
...
def print_flights(departure_city):
    ...
    # 3. Construct the SQL query (being careful to include quote marks
    #    around the city code string as per the SQL syntax)
    pass
